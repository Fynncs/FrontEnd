...
export class Usuario extends ModeloEstado<IUsuario> implements IUsuario {
  ...
  private _estadoCivil: 'solteiro' | 'casado' | 'divorciado' | 'viúvo' | 'outro';
  ...
  get sexo(): 'masculino' | 'feminino' | 'outro' | 'não informado' { return this._sexo; }
  set sexo(value: 'masculino' | 'feminino' | 'outro' | 'não informado') { this._sexo = value; }

  get nacionalidade(): string { return this._nacionalidade; }
  set nacionalidade(value: string) { this._nacionalidade = value; }

  get estadoCivil(): 'solteiro' | 'casado' | 'divorciado' | 'viúvo' | 'outro' { return this._estadoCivil; }
  set estadoCivil(value: 'solteiro' | 'casado' | 'divorciado' | 'viúvo' | 'outro') { this._estadoCivil = value; }

  get profissao(): string | undefined { return this._profissao; }
  set profissao(value: string | undefined) { this._profissao = value; }

  get formacaoAcademica(): string | undefined { return this._formacaoAcademica; }
  set formacaoAcademica(value: string | undefined) { this._formacaoAcademica = value; }

  get username(): string | undefined { return this._username; }
  set username(value: string | undefined) { this._username = value; }

  get senha(): string | undefined { return this._senha; }
  set senha(value: string | undefined) { this._senha = value; }
}